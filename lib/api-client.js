...
module.exports = {
    ...
    addresses: {
        ...
        create(user, data, callback) {
            _exec('post', '/users/{user}/addresses', { user }, data, callback);
        },

        get(user, address, callback) {
            _exec('get', '/users/{user}/addresses/{address}', { user, address }, false, callback);
        },

        update(user, address, updates, callback) {
            _exec('put', '/users/{user}/addresses/{address}', { user, address }, updates, callback);
        },

        del(user, address, callback) {
            _exec('del', '/users/{user}/addresses/{address}', { user, address }, false, callback);
        }
    },
    ...
    '2fa': {
        setupTotp(user, issuer, ip, callback) {
            _exec('post', '/users/{user}/2fa/totp/setup', { user }, { issuer, ip }, callback);
        },
        ...
        setupU2f(user, ip, callback) {
            _exec('post', '/users/{user}/2fa/u2f/setup', { user }, { ip, appId: config.u2f.appId }, callback);
        },
        ...
        startU2f(user, ip, callback) {
            _exec('post', '/users/{user}/2fa/u2f/start', { user }, { ip, appId: config.u2f.appId }, callback);
        },
    ...
    mailboxes: {
        ...
        get(user, mailbox, args, callback) {
            ...
            _exec('get', '/users/{user}/mailboxes/{mailbox}', args, false, callback);
        },
    ...
    messages: {
        ...
        update(user, mailbox, data, callback) {
            _exec('put', '/users/{user}/mailboxes/{mailbox}/messages', { user, mailbox }, data, callback);
        },
